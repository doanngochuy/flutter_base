...
class EmoTextFieldSearch extends StatefulWidget {
  ...
  @override
  _EmoTextFieldSearchState createState() => _EmoTextFieldSearchState();
}

class _EmoTextFieldSearchState extends State<EmoTextFieldSearch> {
